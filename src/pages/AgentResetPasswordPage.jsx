      ...
      <main className="mx-auto flex min-h-screen w-full max-w-5xl items-center px-5 py-8 sm:px-8">
        <section className={`mx-auto w-full max-w-xl rounded-3xl border p-8 sm:p-10 ${isDark ? "border-white/10 bg-[#111f37]/95" : "border-[#dbe4f2] bg-white"}`}>
          ...
          <form className="mt-7 space-y-5" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="agent-reset-password" className={`mb-2 block text-sm font-medium ${isRTL ? "text-right" : "text-left"}`}>{ui.passwordLabel}</label>
            ...
            <div>
              <label htmlFor="agent-reset-confirm-password" className={`mb-2 block text-sm font-medium ${isRTL ? "text-right" : "text-left"}`}>{ui.confirmLabel}</label>
              <div className="relative">
                <Lock
                  size={18}
                  className={`pointer-events-none absolute top-1/2 -translate-y-1/2 ${
