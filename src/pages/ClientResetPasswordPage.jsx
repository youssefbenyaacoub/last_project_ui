...
import { resetClientPasswordWithLink } from "../api";

const copyByLanguage = {
  fr: {
    title: "Reinitialiser mot de passe client",
    subtitle: "Definissez un nouveau mot de passe fort pour votre compte client.",
    home: "Accueil",
    backToLogin: "Retour connexion client",
  ...
  en: {
    ...
    subtitle: "Set a strong new password for your client account.",
    home: "Home",
...
export function ClientResetPasswordPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      setLoading(true);
      await resetClientPasswordWithLink({
        token,
